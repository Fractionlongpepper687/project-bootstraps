...
6. Follow the on-screen prompts. Click Next until the installation finishes.
...
1. Type the name of your project in the box.
2. Select Python or TypeScript from the list.
3. Choose the folder on your computer where you want to keep your project files.
4. Click the Generate button.
5. Wait for the tool to finish creating the files. A toast notification appears when the process finishes.

You now have a folder ready to use with pre-set security rules and project structures.

## 🛡️ Managing project guardrails
...
* `src`: This is where your main code lives.
* `docs`: Use this folder for your text notes and guides.
* `tests`: Keep your verification files here.
* `config`: This holds the security rules created by the tool.
